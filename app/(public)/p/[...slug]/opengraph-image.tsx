...
export default async function Image({
  ...
  const title = page?.title || "LambdaIDX Knowledge Base";
  const excerpt =
    page?.excerpt || "Infraestructura de conocimiento jerarquico y lectura academica.";
  const path = page?.path || `/p/${slug.join("/")}`;
