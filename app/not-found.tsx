  ...
  return (
    <div className="relative min-h-screen bg-[var(--background)] text-[var(--foreground)] selection:bg-[var(--foreground)] selection:text-[var(--background)] flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-xl">
        <div className="mb-8 p-4 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl">
          <Terminal className="w-12 h-12 text-zinc-500 dark:text-zinc-600" />
        </div>

        <div className="px-3 py-1 rounded-full border border-red-300/70 dark:border-red-900/50 bg-red-100/60 dark:bg-red-950/20 text-[10px] font-mono text-red-600 dark:text-red-500 mb-6 tracking-tight uppercase">
