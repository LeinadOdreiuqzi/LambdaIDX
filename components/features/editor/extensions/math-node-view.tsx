  ...
  return (
    <NodeViewWrapper className="inline-block relative group mx-1">
      <span
        ...
        className={cn(
          "inline-block cursor-pointer px-1 rounded transition-colors min-w-[1ch] min-h-[1em]",
          selected || isEditing ? "bg-zinc-100 dark:bg-zinc-800 ring-1 ring-zinc-300 dark:ring-zinc-700" : "hover:bg-zinc-50 dark:hover:bg-zinc-900"
        )}
      />
